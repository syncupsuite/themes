...
:root {
  ...
  --primitive-color-terracotta-lombardo-50: #FFEDE5;
  /* Terracotta (Lombardo) 100 */
  --primitive-color-terracotta-lombardo-100: #FFD3C5;
  /* Terracotta (Lombardo) 200 */
  --primitive-color-terracotta-lombardo-200: #F8B9A6;
  /* Terracotta (Lombardo) 300 */
  --primitive-color-terracotta-lombardo-300: #ED9F88;
  /* Terracotta (Lombardo) 400 */
  --primitive-color-terracotta-lombardo-400: #E18469;
  /* Terracotta (Lombardo) 500 */
  --primitive-color-terracotta-lombardo-500: #D4694A;
  /* Terracotta (Lombardo) 600 */
  --primitive-color-terracotta-lombardo-600: #A2462C;
  /* Terracotta (Lombardo) 700 */
  --primitive-color-terracotta-lombardo-700: #73250D;
  /* Terracotta (Lombardo) 800 */
  --primitive-color-terracotta-lombardo-800: #460400;
  /* Terracotta (Lombardo) 900 */
  --primitive-color-terracotta-lombardo-900: #1C0000;
  /* Slate (Olivetti) 50 */
  --primitive-color-slate-olivetti-50: #F0F6FC;
  /* Slate (Olivetti) 100 */
  --primitive-color-slate-olivetti-100: #C5CED7;
  /* Slate (Olivetti) 200 */
  --primitive-color-slate-olivetti-200: #9CA7B3;
  /* Slate (Olivetti) 300 */
  --primitive-color-slate-olivetti-300: #758291;
  /* Slate (Olivetti) 400 */
  --primitive-color-slate-olivetti-400: #4F5F70;
  /* Slate (Olivetti) 500 */
  --primitive-color-slate-olivetti-500: #2C3E50;
  /* Slate (Olivetti) 600 */
  --primitive-color-slate-olivetti-600: #1F2F3E;
  /* Slate (Olivetti) 700 */
  --primitive-color-slate-olivetti-700: #13202D;
  /* Slate (Olivetti) 800 */
  --primitive-color-slate-olivetti-800: #08121D;
  /* Slate (Olivetti) 900 */
  --primitive-color-slate-olivetti-900: #01060E;
  /* Stone (Travertino) 50 */
  --primitive-color-stone-travertino-50: #F6F5F4;
  /* Stone (Travertino) 100 */
  --primitive-color-stone-travertino-100: #F6F4F2;
  /* Stone (Travertino) 200 */
  --primitive-color-stone-travertino-200: #F6F4F1;
  /* Stone (Travertino) 300 */
  --primitive-color-stone-travertino-300: #F7F4F0;
  /* Stone (Travertino) 400 */
  --primitive-color-stone-travertino-400: #F7F3EF;
  /* Stone (Travertino) 500 */
  --primitive-color-stone-travertino-500: #F7F3EE;
  /* Stone (Travertino) 600 */
  --primitive-color-stone-travertino-600: #B2AFAA;
  /* Stone (Travertino) 700 */
  --primitive-color-stone-travertino-700: #726F6B;
  /* Stone (Travertino) 800 */
  --primitive-color-stone-travertino-800: #373533;
  /* Stone (Travertino) 900 */
  --primitive-color-stone-travertino-900: #070604;
  /* Sage (Lombardo) 50 */
  --primitive-color-sage-lombardo-50: #EFF8EF;
  /* Sage (Lombardo) 100 */
  --primitive-color-sage-lombardo-100: #DCE9DA;
  /* Sage (Lombardo) 200 */
  --primitive-color-sage-lombardo-200: #C8DAC6;
  /* Sage (Lombardo) 300 */
  --primitive-color-sage-lombardo-300: #B5CCB3;
  /* Sage (Lombardo) 400 */
  --primitive-color-sage-lombardo-400: #A2BD9F;
  /* Sage (Lombardo) 500 */
  --primitive-color-sage-lombardo-500: #8FAF8C;
  /* Sage (Lombardo) 600 */
  --primitive-color-sage-lombardo-600: #658062;
  /* Sage (Lombardo) 700 */
  --primitive-color-sage-lombardo-700: #3D543C;
  /* Sage (Lombardo) 800 */
  --primitive-color-sage-lombardo-800: #1A2C18;
  /* Sage (Lombardo) 900 */
  --primitive-color-sage-lombardo-900: #010800;
  /* Sand (Intonaco) 50 */
  --primitive-color-sand-intonaco-50: #FBF4EA;
  /* Sand (Intonaco) 100 */
  --primitive-color-sand-intonaco-100: #F0E4D5;
  /* Sand (Intonaco) 200 */
  --primitive-color-sand-intonaco-200: #E5D5C0;
  /* Sand (Intonaco) 300 */
  --primitive-color-sand-intonaco-300: #DAC6AB;
  /* Sand (Intonaco) 400 */
  --primitive-color-sand-intonaco-400: #CFB796;
  /* Sand (Intonaco) 500 */
  --primitive-color-sand-intonaco-500: #C4A882;
  /* Sand (Intonaco) 600 */
  --primitive-color-sand-intonaco-600: #917958;
  /* Sand (Intonaco) 700 */
  --primitive-color-sand-intonaco-700: #614D32;
  /* Sand (Intonaco) 800 */
  --primitive-color-sand-intonaco-800: #34250E;
  /* Sand (Intonaco) 900 */
  --primitive-color-sand-intonaco-900: #0D0400;
  /* Neutral 50 */
  --primitive-color-neutral-50: #FFF6F3;
  /* Neutral 100 */
  --primitive-color-neutral-100: #F6ECE9;
  /* Neutral 200 */
  --primitive-color-neutral-200: #E5DCD9;
  /* Neutral 300 */
  --primitive-color-neutral-300: #CBC2BF;
  /* Neutral 400 */
  --primitive-color-neutral-400: #9F9693;
  /* Neutral 500 */
  --primitive-color-neutral-500: #756C6A;
  /* Neutral 600 */
  --primitive-color-neutral-600: #534B49;
  /* Neutral 700 */
  --primitive-color-neutral-700: #38312F;
  /* Neutral 800 */
  --primitive-color-neutral-800: #201917;
  /* Neutral 900 */
  --primitive-color-neutral-900: #0B0605;
  /* Accent 50 */
  --primitive-color-accent-50: #EAF4FF;
  /* Accent 100 */
  --primitive-color-accent-100: #C6D5FF;
  /* Accent 200 */
  --primitive-color-accent-200: #A4B5FF;
  /* Accent 300 */
  --primitive-color-accent-300: #8396F1;
  /* Accent 400 */
  --primitive-color-accent-400: #6477E3;
  /* Accent 500 */
  --primitive-color-accent-500: #4955D4;
  /* Accent 600 */
  --primitive-color-accent-600: #333AA8;
  /* Accent 700 */
  --primitive-color-accent-700: #1F1F7F;
  /* Accent 800 */
  --primitive-color-accent-800: #0F0257;
  /* Accent 900 */
  --primitive-color-accent-900: #050032;
